...
namespace PageViewController.ViewControllers
{
	...
	{ 
		...
		public override void ViewDidLoad ()
		{
			...
			var startVC = this.ViewControllerAtIndex (0) as UIViewController;
		...
		private class PageViewControllerDataSource : UIPageViewControllerDataSource{
			...
			{
				var vc = (referenceViewController as UINavigationController).ViewControllers[0] as ContentViewController;
